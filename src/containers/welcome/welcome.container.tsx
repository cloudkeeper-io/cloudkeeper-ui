    ...
    return (
        <Wrapper className={className}>
            <Content>
                ...
                <Section>
                    <Text>You don't have any projects yet. To start using the cloudkeeper create your first project.</Text><br/>
                    <Text>After that we'll guide you through a simple setup process which will take around <AccentText>2 minutes</AccentText> and will require <AccentText>no code changes.</AccentText></Text>
                </Section>
